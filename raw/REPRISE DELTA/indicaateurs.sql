...
--Nombre de comptes de la clientèle
...
-- Comptes d'épargnes Personnes Physiques
select count(*) 
from mouvement2011
...
-- Comptes d'épargnes Personnes Morales
select count(*) 
from mouvement2009
...
-- Comptes chèques personnes morales
select count(*) 
from mouvement2009
...
-- Comptes chèques personnes physiques
select count(*) 
from mouvement2011
where mvtw_cha between '37200' and '37299'
or mvtw_cha = '37180'
...
--- Nombre de clients et répartitions par agence ---
