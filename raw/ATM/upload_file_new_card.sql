...
where cf.cust_ac = de.num_compte
and de.code_transaction = tt.trn_code
and de.code_transaction not in  ('ELS','EFS','EPS')
and cf.date_crea ='23-NOV-2017'
order by substr(cf.cust_ac,1,3), tt.trn_code;
--- select des cartes d'une journée ----
select * from carte_file cf
where cf.date_crea ='23-NOV-2017'
order by cust_ac;

--- carte dont les comptes ne sont pas dans DEUPLD pour un e journée
select * from carte_file cf
