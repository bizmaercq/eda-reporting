  ...
  cursor c1 is
    ...
    BOOK_DATE
      from (select ac_no,
                   ...
                   CB_SPECIFIC_CLIENT,
                   cust_gl,
                   (select category from gltm_glmaster where gl_code = gl_code2) category,
                   CUSTOMER_CAT,
                   MODULE,
                   '' FINANCIAL_CYCLE,
                   '' PERIODIC_CODE,
		   ...
		   '' BOOK_DATE
              ...
              'R','1'))
                                             ...
                                             DECODE(CUST_GL,
                                                    ...
                                                    BIPKS_REPORT.fn_get_ACCBAL_AS_DT(b.ac_gl_no,
                                             ...
                                             '' MODULE,
                                             '' IB
                               from acvws_all_ac_entries Z, sttb_account B
                              WHERE
