SELECT "Libellé Poste","Code Poste",round(sum("[0,5[")) "[0,5[" ,round(sum("[5,10[")) "[5,10[",round(sum("[10,15[")) "[10,15[", round(sum("[15,20[")) "[15,20[", 
...
'H51','Bons de Caisse',
'H52','Certificats de Dépôt',
'H55','Autres Comptes à régime spécial',
'H59','',
'H61','Comptes de dépot à terme',
'H69','',
'H71','Comptes courants créditeurs',
'H72','Comptes de chèques créditeurs',
'H73','Comptes sur livrets',
'H74','Dépôts de garantie recus de la clièntele',
'H79','',
'H81','',
'H82','',
'H84',''
) "Libellé Poste" ,tb.central_bank_code "Code Poste",tb.account_number,
...
union
 SELECT decode(tb.central_bank_code,'H74','Dépôts de garantie recus de la clièntele') "Libellé Poste" ,tb.central_bank_code "Code Poste",tb.account_number,
...
group by  "Libellé Poste","Code Poste";
