...
From   (Select Account_Number
              ...
              ,Nvl((Select (Sum(Nvl(Cr_Bal_Lcy, 0)) - Sum(Nvl(Dr_Bal_Lcy, 0)))
                   ...
                   And    (Category In ('1', '2', '5', '6', '7', '8', '9') Or
                         (Category In ('3', '4') And Ccy_Code = 'XAF')))
                  ,0) Gl_Closing_Balance_b
              ,Gl_Opening_Balance
              ,Ib
              ,Trn_Dt
              ,Book_Date
        From   (Select Nvl(a.Account_Number, b.Gl_Code) Account_Number
                      ,Nvl(a.Description, b.Gl_Desc) Description
                       --  ,Nvl(Glcode1, Substr(b.Gl_Code, 1, 5)) Glcode1
                      ,Case
                           When b.Gl_Code='344501000' Then
                            '3441'
                           When b.Gl_Code='344502000' Then
                            '3442'
                           When b.Gl_Code='344503000' Then
                            '3443'
                           When b.Gl_Code='344504000' Then
                            '3444'
                           When b.Gl_Code='345001000' Then
                            '3451'
                           When b.Gl_Code='345002000' Then
                            '3452'
                           When b.Gl_Code='345003000' Then
                            '3453'
                           When b.Gl_Code='394501000' Then
                            '3941'
                           When b.Gl_Code='394502000' Then
                            '3942'
                           When b.Gl_Code='394503000' Then
                            '3943'
                           When b.Gl_Code='394504000' Then
                            '3944'
                           When b.Gl_Code='395410000' Then
                            '3951'
                           When b.Gl_Code='395420000' Then
                            '3952'
                           When b.Gl_Code='395430000' Then
                            '3953'                            
                           Else
                           Nvl(Glcode1, Substr(b.Gl_Code, 1, 5))
                       End Glcode1
                      ,b.Gl_Code Gl_Code2
