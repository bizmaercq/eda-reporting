...
-- mise à jour des comptes des nouveaux fonctionnaires à partir des fichiers des nouveaux comptes
...
--- Suppression d'une ligne de salaire non reçu.
select * from sal_cenadi where sal_matricule='074481H' and sal_date_paie='25-sep-2014' for update;
---- Historique des salaiares reçus par fonctionnaire
...
---- Mise à Jour Historique des salaiares reçus pour le mois
...
---affichage des salaires importés
