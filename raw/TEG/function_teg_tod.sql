CREATE OR REPLACE FUNCTION "NFCREAD"."TEG_TOD" (pmontant number, pfrais number default 0, pemi number, pdebut date, pfin date, pmodetaux number
) return varchar2 is
...
select pfin, pemi, pemi from dual;
/*
...
*/
--ici 
vprincipal := pmontant; vvalue_date := pdebut; vno_of_installments :=1;
vfrais := pfrais; vamount_due_sum := pemi; vamount_due_avg := pemi;
--
